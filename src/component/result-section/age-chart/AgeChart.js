...
export default function AgeChart(props){
  ...
  const nested = infectGp.map(gp=>{
    ...
    let label = ""
    switch(gp) {
      case 'infected_case_0':
        label = '0 - 9 歲'
        break;
      case 'infected_case_1':
        label = '10 - 19 歲'
        break;
      case 'infected_case_2':
        label = '20 - 29 歲'
        break;
      case 'infected_case_3':
        label = '30 - 39 歲'
        break;
      case 'infected_case_4':
        label = '40 - 49 歲'
        break;
      case 'infected_case_5':
        label = '50 - 59 歲'
        break;
      case 'infected_case_6':
        label = '60 - 69 歲'
        break;
      case 'infected_case_7':
        label = '70 - 79 歲'
        break;
      case 'infected_case_8':
        label = '80 - 89 歲'
        break;
      case 'infected_case_9':
        label = '90 - 99 歲'
        break;
      default:
        label = ""
